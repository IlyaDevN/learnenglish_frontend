...
export default function LessonTranslation({
	...
	async function generateAiPair(direction, amountOfGeneratedSentences, examplesData = initialData) {
			...
			try {
				...
				let prompt;
				if (direction === "ru-en") {
					prompt = `Проанализируй следующие пары предложений (русский; английский): ${examplesRu}; ${examplesEn}. Выдели из них все слова, словосочетания, лексику, грамматические времена и грамматические конструкции.
					На основе сделанных выводов (только те грамматические времена и слова которые ты выделила) сгенерируй ${amountOfGeneratedSentences.value} НОВЫХ коротких русских предложений. 
					...
					prompt = `Проанализируй следующие пары предложений (русский; английский): ${examplesRu}; ${examplesEn}. Выдели из них все слова, словосочетания, лексику, грамматические времена и грамматические конструкции.
					На основе сделанных выводов (только те грамматические времена и слова которые ты выделила) сгенерируй ${amountOfGeneratedSentences.value} НОВЫХ коротких английских предложений.
