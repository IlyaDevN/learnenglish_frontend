...
export default function LessonTranslation({
	...
	async function generateAiPair(direction, amountOfGeneratedSentences, examplesData = initialData) {
			...
			try {
				...
				let prompt;
				if (direction === "ru-en") {
					prompt = `Проанализируй следующие пары предложений (русский; английский): ${examplesRu}; ${examplesEn}. Выдели из них все используемые слова, словосочетания, лексику, грамматические времена и грамматические конструкции.
					ИСПОЛЬЗУЯ ТОЛЬКО ТЕ слова, словосочетания, лексику, грамматические времена и грамматические конструкции выделенные в примере, сгенерируй ${amountOfGeneratedSentences.value} НОВЫХ коротких русских предложений. 
					...
					prompt = `Проанализируй следующие пары предложений (русский; английский): ${examplesRu}; ${examplesEn}. Выдели из них все используемые слова, словосочетания, лексику, грамматические времена и грамматические конструкции.
					ИСПОЛЬЗУЯ ТОЛЬКО ТЕ слова, словосочетания, лексику, грамматические времена и грамматические конструкции выделенные в примере, сгенерируй ${amountOfGeneratedSentences.value} НОВЫХ коротких английских предложений.
        ...
        <div className="relative z-10 flex flex-col gap-4">
            ...
            <div className="relative">
                <UiButton
                    className={clsx(
                        currentAnswer &&
                            "pr-14 text-left text-lg font-bold text-yellow-900 normal-case bg-white bg-opacity-50 pointer-events-none",
